...
const transactions = [
  { id: 1, date: '2024-07-30', description: 'Oil Sales - Well 001', amount: 15420.5, type: 'Income', status: 'Completed' },
  { id: 2, date: '2024-07-30', description: 'Equipment Maintenance', amount: -2850.0, type: 'Expense', status: 'Completed' },
  ...
  { id: 5, date: '2024-07-28', description: 'Oil Sales - Well 002', amount: 12350.0, type: 'Income', status: 'Completed' },
  { id: 6, date: '2024-07-28', description: 'Contractor Services', amount: -5200.0, type: 'Expense', status: 'Completed' },
  { id: 7, date: '2024-07-27', description: 'Royalty Payment', amount: -3250.5, type: 'Expense', status: 'Completed' },
